...
public class Lucene {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      s = "../../Step 1-Corpus Generation/Corpus";
    ...
    try {
      ...
      String contents = new String(Files.readAllBytes(Paths.get("../../Step 3- Query Cleaning/ErrorQueries.txt")));
      for(String str:contents.split("\r\n")){
        if(str != "")
        {
          ...
          for (int i = 0; i < hits.length; ++i) {
            ...
            writer.println(q_id+" Q0 "+d.get("path").substring(pos,tot-4)+" "+(i+1)+" "+hits[i].score+" LuceneNoStopNoStem");
          }
        }
      }
