...
def indexer(inp):
    ...
    paths = os.path.join(paths, "Task 1\Corpus")
    ...
    if inp==1:
        ...
        filename = "Indexing_Outputs/Bigram_index.txt"
    elif inp==3:
        filename = "Indexing_Outputs/Trigram_index.txt"
...
if __name__ == "__main__":
    ...
    inp = input("Choose the n-gram which should be considered as a term in the inverted index:\n" +
                    "Enter 1 for unigram \n" +
                    "Enter 2 for bigram\n"
                    "Enter 3 for trigram\n")
